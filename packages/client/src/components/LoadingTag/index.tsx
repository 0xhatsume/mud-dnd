...
export const LoadingTag = () => {
  return (
    <button type="button" className="bg-[#5F5453] text-[#E8DEDA] flex align-middle
                                    rounded-lg p-2 border-gray-700 border-2 drop-shadow-md"
                                    disabled>
        <svg className="w-6 h-6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-orange-600" 
        ...
        <span className='font-mono'>CoNjuRiNg uR WoRLd...</span>
    </button>
  )
}
