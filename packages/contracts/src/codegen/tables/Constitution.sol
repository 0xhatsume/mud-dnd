...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Constitution")));
bytes32 constant ConstitutionTableId = _tableId;
...
library Constitution {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("Constitution", _fieldNames);
  }
