...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Wallet")));
bytes32 constant WalletTableId = _tableId;
...
library Wallet {
  ...
  /** Get balance */
  function get(address owner) internal view returns (uint256 balance) {
  ...
  function get(IStore _store, address owner) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
  ...
  /** Set balance */
  function set(address owner, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
  ...
  function set(IStore _store, address owner, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
